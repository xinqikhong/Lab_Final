...
class _SellerOrderDetailsScreenState extends State<SellerOrderDetailsScreen> {
                        ...
                        child: Padding(
                          ...
                          child: Row(children: [
                            CachedNetworkImage(
                              ...
                              fit: BoxFit.cover,
                              imageUrl:
                                  "${Config.server}/barterit/images/items/${orderdetailsList[index].itemId}.png",
  ...
  void loadorderdetails() {
    http.post(
        Uri.parse(
            "${Config.server}/barterit/php/load_sellerorderdetails.php"),
        body: {
  ...
  void loadbuyer() {
    http.post(Uri.parse("${Config.server}/barterit/php/load_user.php"),
        body: {
  ...
  void submitStatus(String st) {
    ...
    http.post(
        Uri.parse("${Config.server}/barterit/php/set_orderstatus.php"),
        body: {
